"""Extra configurations bringing N=empty into the (data N, test N) sweep.

The main grid (run_noncanon_grid.py / results/e2_noncanon/) covers seven
...
Same K, v, abundance, R, and n_alt=n_null=2500 as the main grid
...
Run:
    python \\
        -m simulation.run_noncanon_grid_wcf_configs
"""
...
N_ALT = N_NULL = 2500
NB_WORKERS = 8
BASE_SEED = 9090                       # distinct from run_noncanon_grid.py's BASE_SEED (2025)
